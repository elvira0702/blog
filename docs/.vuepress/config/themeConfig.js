...
module.exports = {
  ...
  repo: 'Kylin3216/blog', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'iceKylin', // 必需
    link: 'https://github.com/Kylin3216', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    ...
    icons: [
      {
        ...
        title: '发邮件',
        link: 'mailto:xiasuwan@gmail.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/Kylin3216',
      },
      // {
      //   iconClass: 'icon-erji',
      //   title: '听音乐',
